 ...
 * persistence layer (DAO), meaning that the Service class performs tasks that aren't done through the web or
 * SQL, such as programming tasks like checking that the input is valid, conducting additional security checks,
...
public class BookService {
     ...
     * An ISBN will be provided in Book. Method should check if the book ISBN already exists before it attempts to persist it.
     *
